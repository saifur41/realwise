				...
				<div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative" style="background-color: #F2C98A">
					...
					<div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
						...
						<div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
							<!--begin::Logo-->
							<a href="../../demo14/dist/index.html" class="py-9 mb-5">
								<img alt="Logo" src="{{asset('public/assets/media/logos/logo-2.svg')}}" class="h-60px" />
							</a>
							<!--end::Logo-->
							<!--begin::Title-->
							<h1 class="fw-bolder fs-2qx pb-5 pb-md-10" style="color: #986923;">Welcome to Realwise</h1>
							<!--end::Title-->
							<!--begin::Description-->
							<p class="fw-bold fs-2" style="color: #986923;">Property Managament System
					...
					<div class="d-flex flex-center flex-column flex-column-fluid">
						...
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
                                                    @if ($message = Session::get('success'))
                                                                        ...
                                                                        @endif
							<!--begin::Form-->
                                                        <form class="form w-100" method="post"  id="kt_sign_in_form" action="{{asset('backend_login')}}">
                                                            @csrf
								<!--begin::Heading-->
								<div class="text-center mb-10">
									<!--begin::Title-->
									<h1 class="text-dark mb-3">Sign In to Realwise</h1>
									<!--end::Title-->
									<!--begin::Link-->
								...
								<div class="fv-row mb-10">
									...
									<!--end::Label-->
									<!--begin::Input-->
                                                                        <input class="form-control form-control-lg form-control-solid" type="text" name="email" required="" autocomplete="off" />
									<!--end::Input-->
								</div>
								<!--end::Input group-->
								<!--begin::Input group-->
