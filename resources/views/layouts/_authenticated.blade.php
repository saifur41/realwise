<!--begin::Body-->
    ...
    <div id="app">
        <div id="wrapper">
            ...
            <div class="d-flex flex-column custom-wrapper" id="content-wrapper">
                <div id="content">
                    @include("_top_navigation")
   ...
   <!--begin::Scrolltop-->
		...
		<script src="{{asset('public/assets/js/custom/modals/create-campaign.js')}}"></script>
		<script src="{{asset('public/assets/js/custom/modals/users-search.js')}}"></script>
